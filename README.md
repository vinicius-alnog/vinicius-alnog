...
- ☕ Projetos em **Java** — orientação a objetos, estruturas de dados e lógica de programação
- 🗄️ Consultas **SQL** — modelagem relacional e manipulação de dados
- 📊 Dashboards em **Power BI** — visualização de indicadores de negócio

---

## 💼 Meu diferencial

Venho de uma formação forte de Administração, o que significa que entendo o **problema de negócio** antes de pensar na solução técnica. Já trabalhei com análise de dados, mapeamento de processos e projetos com metodologias ágeis e hoje aplico isso diretamente no desenvolvimento de software. Não construo projetos só para praticar: os projetos que desenvolvo resolvem problemas reais e já foram usados em produção.

---

## 📫 Vamos conversar?

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/viniciusalnogueira/)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:vinicius.alnog@gmail.com)

---

> *"Em transição, mas não em desvantagem."*
